...
const ProjectTemplate = (project: projectTemplateInterFace) => {
    ...
    return (
        <div className='shadow-md w-full mb-5 flex flex-row justify-left place-items-start rounded-xl mx-auto overflow-hidden hover:shadow-2xl hover:mb-5 transition duration-250 dark:border-[1px] dark:border-gray-700 '>
            <div className='mx-3 mb-5 lg:mt-8 ms-5'>
                <Link href={`/questions/${project._id}`} className='mt-2 heading_2 font-[900]'>{project.name} </Link>
